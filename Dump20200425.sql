...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_spanish_ci COMMENT='Tabla con todas las partidas pertenecientes a los asientos generados y almacenados en el libro diario.\n';
...
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8 COLLATE=utf8_spanish_ci COMMENT='Es una recopilación de todas las cuentas contables en las que se realizan las operaciones y en las que se llevan la contabilidad de la empresa.';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `Catalogo_cuentas` VALUES (1,'1','Activos','Destinada a los activos',1,'Nicaragua',1,'ANCC101112',1,1),(2,'1.1','Activos Corrientes','Destinada a los activos corrientes',1,'Nicaragua',1,'ANCC101112',1,1),(3,'1.1.1.001','Caja','Destinada a la caja',1,'Nicaragua',1,'ANCC101112',1,1);
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_spanish_ci COMMENT='Tabla en donde se guardan todas la anotaciones realizadas en el libro diario';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_spanish_ci COMMENT='Tabla en donde se guardan todas la anotaciones realizadas en el libro mayor';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `Periodos_contables` VALUES (1,'2000-04','2000-04-01','2000-04-30',1,'ANCC101112',1),(2,'2000-05','2000-05-01','2000-05-29',1,'ANCC101112',1),(3,'2000-05','2000-05-01','2000-05-31',1,'ANCC101112',1);
...
CREATE TABLE `Rol` (
  ...
  PRIMARY KEY (`idRol`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_spanish_ci COMMENT='Esta tabla contiene la información sobre el rol que fue otorgado a cada empleado en el sistema de la empresa.';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `Tabla_moneda` VALUES (1,'Euro','EUR','Paises Bajos',37.39,1,1,'OCSO040506'),(2,'Colon Costarricense','CRC','Costa Rica',0.061,1,1,'OCSO040506'),(3,'Dolar Estado Unidense','USD','Estados Unidos',34.55,1,1,'OCSO040506');
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_spanish_ci COMMENT='Esta tabla contiene la información de los usuarios con sus respectivos roles en la empresa, lo cual permitirá llevar un control sobre las opciones que tiene disponible el usuario.';
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2020-04-25 17:17:46
